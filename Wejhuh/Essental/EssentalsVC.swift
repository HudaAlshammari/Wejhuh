...
class EssentalsVC: UIViewController , UICollectionViewDelegate , UICollectionViewDataSource , UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath){
        ...
        case 0 :
            imageEssentaltSet = UIImage(named: "details1")
            nameEssentalSet = "Safety travel tips"
            desEssentalSet = "stay informed .. While the restrictions related to travel are eased, you can ensure that you receive the latest advice in the best way available, by following government guidelines. The Saudi Ministry of Health offers a special electronic application under the name (Mawd) for smart phones, which displays the latest health recommendations, and a hotline is available at 937 .."
        case 1 :
            imageEssentaltSet = UIImage(named: "details2" )
            nameEssentalSet = "Laws and etiqutte"
            desEssentalSet = "Swearing, loud behavior, and violating the boundaries of others are behaviors that show a lack of respect. It is advised to respect public decency at all times.. It is a rule in Saudi Arabia that some shops close their doors during prayer times for a short period in order to make room for worship. During the blessed month of Ramadan, the atmosphere in the Kingdom turns into a joyful spiritual atmosphere and allows you to enjoy the greatness of the holy month.. Also, the buying, selling and consuming of alcoholic beverages and drugs is illegal in the Kingdom of Saudi Arabia .."
        case 2 :
            imageEssentaltSet = UIImage(named: "details3" )
        ...
        case 3 :
            imageEssentaltSet = UIImage(named: "details4" )
        ...
        case 4 :
            imageEssentaltSet = UIImage(named: "details5" )
        ...
        case 5 :
            imageEssentaltSet = UIImage(named: "details6" )
